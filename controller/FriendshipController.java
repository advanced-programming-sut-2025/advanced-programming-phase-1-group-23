...
public class FriendshipController extends controller.ControllersController {
    ...
    public Result hug(String command) {

    }

    public Result givingFlowers (String command) {
    ...
    public Result cheatSetFriendship(String command) {
