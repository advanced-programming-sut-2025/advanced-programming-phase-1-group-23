...
public enum Recipe {
    ...
    HashBrowns("hash browns", true, Map.of(Ingredients.POTATO, 1, Ingredients.OIL, 1), 90, 120, Ingredients.HASH_BROWNS),
    ...
    SeafoamPudding("seaform Pudding", true, Map.of(Ingredients.FLOUNDER, 1, Ingredients.MIDNIGHT_CARP, 1), 175, 300, Ingredients.SEAFORM_PUDDING),
