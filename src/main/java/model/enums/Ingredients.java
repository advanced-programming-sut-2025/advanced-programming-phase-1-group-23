...
public enum Ingredients {
    ...
    QUARTZ("quartz", 25, 0),
    EARTH_CRYSTAL("earth crystal", 50, 0),
    FROZEN_TEAR("frozen tear", 75, 0),
    FIRE_QUARTZ("fire quartz", 100, 0),
    EMERALD("emerald", 250, 0),
    AQUAMARINE("aquamarine", 180, 0),
    RUBY("ruby", 250, 0),
    AMETHYST("amethyst", 100, 0),
    TOPAZ("topaz", 80, 0),
    JADE("jade", 200, 0),
    DIAMOND("diamond", 750, 0),
    PRISMATIC_SHARD("prismatic shard", 2000, 0),
    COPPER("copper", 5, 0),
    IRON("iron", 10, 0),
    GOLD("gold", 25, 0),
    IRIDIUM("iridium", 100, 0),
    COAL("coal", 15, 0),

    CHERRY_BOMB("cherry bomb", 50, 0),
    BOMB("bomb", 50, 0),
    MEGA_BOMB("mega bomb", 50, 0),
    SPRINKLER("sprinkler", 0, 0),
    QUALITY_SPRINKLER("quality sprinkler", 0, 0),
    IRIDIUM_SPRINKLER("iridium sprinkler", 0, 0),
    CHARCOAL_KLIN("charcoal klin", 0, 0),
    FURNACE("furnace", 0, 0),
    SCARECROW("scarecrow", 0, 0),
    DELUXE_SCARECROW("deluxe scarecrow", 0, 0),
    BEE_HOUSE("bee house", 0, 0),
    CHEESE_PRESS("cheese press", 0, 0),
    KEG("keg", 0, 0),
    LOOM("loom", 0, 0),
    MAYONNAISE_MACHINE("mayonnaise machine", 0, 0),
    OIL_MAKER("oil maker", 0, 0),
    PRESERVES_JAR("preserves jar", 0, 0),
    DEHYDRATOR("dehydrator", 0, 0),
    GRASS_STARTER("grass starter", 0, 0),
    FISH_SMOKER("fish smoker", 0, 0),
