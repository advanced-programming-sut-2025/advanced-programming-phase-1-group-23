...
public class ProfileController extends ControllersController {
    public static Resualt handleChangeUsername(Command request) {
        try {
            String newUsername = request.body.getOrDefault("username", "").trim();
    ...
    public static Resualt handleUserInfoQuery(Command request) {
        User currentUser = App.getLoggedInUser();
        if (currentUser == null) {
    ...
    public static Resualt handleChangePassword(Command request) {
        try {
    ...
    public static Resualt handleChangeEmail(Command request) {
        try {
    ...
    public static Resualt handleChangeNickname(Command request) {
        try {
